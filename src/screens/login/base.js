    ...
    <ScrollView contentContainerStyle={{flexGrow: 1}}>
      ...
      <BottomSheet
        ...
        <View style={styles.bottomSheetContainer}>
          ...
          <Text style={styles.bottomSheetText}>Please contact our agent through {Constants.AGENT_CONTACT} to reset your password</Text>
          <Button
            title="Close"
            onPress={forgotPasswordOnPress}
      ...
      <BottomSheet
        ...
        <View style={styles.bottomSheetContainer}>
          ...
          <Text style={styles.bottomSheetText}>Please contact our agent through {Constants.AGENT_CONTACT} to register</Text>
          <Button
            title="Close"
            onPress={registerOnPress}
            containerStyle={styles.bottomSheetCloseButtonContainerStyle}
